...
export const Settings = () => {
  return (
    <div className="max-w-[800px] w-full h-[490px] flex flex-col gap-8 items-start ">
      <h4 className="text-[16px] font-[400] text-[#7F7F7F] ">
        Мэдэгдлийн тохиргоо
      </h4>
      <div className="w-full h-[400px] flex flex-col gap-5 py-6 px-5 items-start rounded-[12px] border bg-[#F2F2F2] ">
